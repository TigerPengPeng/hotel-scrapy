...
cd /home/ray/PythonProjects/scrapy_project/scrapys/ctrip/hotel/hotel/ 
if [ $? -ne 0 ];then
    echo "error, cd /home/ray/PythonProjects/scrapy_project/scrapys/ctrip/hotel/hotel/ failed"
    exit $?
fi
