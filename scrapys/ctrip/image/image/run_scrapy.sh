...
cd /home/ray/PythonProjects/scrapy_project/scrapys/ctrip/image/image/ 
if [ $? -ne 0 ];then
    echo "error, cd /home/ray/PythonProjects/scrapy_project/scrapys/ctrip/image/image/ failed" 
    exit $?
fi
